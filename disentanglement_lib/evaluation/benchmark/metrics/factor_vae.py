...
def compute_factor_vae(dataholder,
    ...
    scores_dict["FVAE_train_accuracy"] = (train_accuracy - 1/n_factors)/((n_factors - 1) / n_factors)
    scores_dict["FVAE_eval_accuracy"] = (eval_accuracy - 1/n_factors)/((n_factors - 1) / n_factors)
