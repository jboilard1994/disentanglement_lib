...
class config_rfvae:
    ...
    def get_gin_configs(n_samples, val_per_factor):
        ...
        configs = []
        params_ids, __ = config_rfvae.get_extra_params()
...
class config_fvae:
    ...
    def get_gin_configs(n_samples, val_per_factor):
        ...
        configs = []
        params_ids, __ = config_fvae.get_extra_params()
        for params_id in params_ids:
            batch_size, num_train_eval = params_id
